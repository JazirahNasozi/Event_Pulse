  ...
  return (
    <div className="ticketing-page">
      ...
      <main className="ticketing-main">
        ...
        <section className="share-card"><b>⌯</b><div><strong>Auto-share landing page</strong><span>pulselive.io/e/kampala-summit-25</span></div><button type="button" onClick={() => setShareLabel('✓')} aria-label="Copy landing page link">{shareLabel}</button></section>
      </main>
